          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-8 col-lg-10">
                  <?php if($xVisitante=="1"){ ?><p><?php echo htmlspecialchars($xMap); ?></p><?php } ?>
                  <input class="form-control" id="map" type="<?php if($xVisitante=="1"){ ?>hidden<?php }else{ ?>text<?php } ?>" name="map" value="<?php echo htmlspecialchars($xMap); ?>" />
